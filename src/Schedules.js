...
export default function Schedules({onSchedule, schedulesList, onPomo, addTask, moveUp, moveDown, updateSchedule}) {
    ...
    return (
        <div>
            <div className="leftpanel">
                ...
                <button id="exit-button" onClick={onSchedule}><ImCross cursor="pointer" /></button>
